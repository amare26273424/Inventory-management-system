...
async function downloadUserHelpPDF() {
  try {
    ...
    const userHelpSection =`<div style="max-width: 800px; margin: 0 auto;"> 
    <h1 style="color: #0082e6;">User Help</h1>
     <p> This section provides information and instructions to assist Admin in effectively utilizing the system. </p>
      <h3 style="color: #0082e6;">1.1 Getting Started</h3> 
      <h5 style="color: #333;">Introduction to the system and its purpose for Admin</h5>
       <p> Welcome to the AMU ICT Store user help guide for Admin. This guide aims to provide you with a comprehensive understanding of the system's purpose and functionality to help you effectively manage user accounts and perform administrative tasks. </p>
       <p>
      ...
      <h5 style="color: #333;">Overview of User Interface Elements Relevant to Admin:</h5>
      <p>
      ...
      <h5 style="color: #333;">Adding a User:</h5>
      ...
      <h5 style="color: #333;">Updating a User:</h5>
      <p>
      ...
      <h5 style="color: #333;">Viewing Users:</h5>
      ...
      <h5 style="color: #333;">Deleting a User:</h5>
      ...
      <h5 style="color: #333;">Q1: How can I add a new user to the Store Management System?</h5>
      ...
      <p>
        ...
        option to access the page displaying all the
